...
func Eval(node ast.Node, env *object.Environment) object.Object {
	...
	case *ast.IndexExpression:
		...
		return evalIndexExpressioin(left, index)
...
func applyFunction(fn object.Object, args []object.Object) object.Object {
	...
	case *object.Function:
		...
		evalueated := Eval(fn.Body, extendedEnv)
		return unrwrapReturnValue(evalueated)
	case *object.Builtin:
		return fn.Fn(args...)
	default:
...
func unrwrapReturnValue(obj object.Object) object.Object {
...
func evalIndexExpressioin(left, index object.Object) object.Object {
	switch {
...
func evalHashLiteral(node *ast.HashLiteral, env *object.Environment) object.Object {
	...
	for keyNode, valueNode := range node.Pairs {
		...
		if !ok {
			return newError("nusuable as hash key %s", key.Type())
		}
